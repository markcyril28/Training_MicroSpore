...
YOLO_MODELS=(
    ...
    "yolov5xu.pt"   # xlarge   - slowest, best accuracy
...
WORKERS_LIST=(
    ...
    # 8                     # mid-range desktop
    # 12                    # high-end desktop
    16                      # workstation (RTX 4000 Ada system)
)
...
CACHE_LIST=(
    ...
    "ram"                   # RAM cache (fastest - workstation has plenty of RAM)
    # false                 # no cache (slowest)
)

AMP_LIST=(
    true                    # mixed precision (recommended - faster on Ada architecture)
...
print_header "Microspore Phenotyping - YOLO Training (Grid Search)"
